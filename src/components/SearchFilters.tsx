...
export const SearchFilters = ({
  ...
  return (
    <section className="px-6 py-12 max-w-7xl mx-auto border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 transition-colors">
      <div className="space-y-8">
        ...
        <div className="max-w-md">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-11 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-gray-400 dark:focus:border-gray-500 focus:ring-0 h-12"
            />
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative" ref={sortDropdownRef}>
            ...
            {showSortDropdown && (
              <div className="absolute top-full mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-10">
                {sortOptions.map(option => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
                      sortBy === option.value ? 'bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300'
                    }`}
                  >
                    {option.label}
                  </button>
          ...
          <div className="relative" ref={sourceDropdownRef}>
            <Button
              ...
              className={`border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-gray-400 dark:hover:border-gray-500 ${
                sourceFilter.length > 0 ? 'text-gray-900 dark:text-white border-gray-400 dark:border-gray-500' : 'text-gray-700 dark:text-gray-300'
              }`}
            >
              ...
              <div className="absolute top-full mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-10">
                {sourceOptions.map(option => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
                      sourceFilter.includes(option.value) ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'
                    }`}
                  >
                    {option.label}
                  </button>
